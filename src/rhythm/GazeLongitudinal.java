...
public class GazeLongitudinal implements Processor {
	...
	public static final double DefaultSessionB = 0.2;
	public static final double DefaultLastB = -0.8;
	
	public GazeLongitudinal sessionB(double b) {
		sessionB = b;
		return this;
	}
	
	public GazeLongitudinal lastB(double b) {
		lastB = b;
		return this;
	}
	...
	private double adjust(Context c, double p0) {
		...
		double adjust = sessionB*sessions*a + (last ? lastB*a : 0);
